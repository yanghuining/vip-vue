...
<template>
 ...
 <br>
  ...
  <el-radio-group v-model="radio">
    ...
    <el-radio :label="2">学习机</el-radio>
    <el-radio :label="3">高端</el-radio>
   ...
   <br>
  <el-form>
  <el-button @click="addactivity()" type="primary" size="medium">创建老带新活动
  </el-button>
  </el-form>
 <br>
 <el-form>    
   2.营销专题活动数据构造</el-form>
     <br>
    <el-form>
  <el-button @click="activity()" type="primary" size="medium">创建营销专题活动
     </el-button>
</el-form>
